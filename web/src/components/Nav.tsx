...
export default function Nav() {
  ...
  return (
    <header className="rounded-3xl border border-surface bg-surface-1 px-3 shadow-lg backdrop-blur">
          ...
          return (
            <Link
              ...
              className={`rounded-full px-4 py-2 transition ${
                isActive
                  ? "btn-primary"
                  : "text-slate-600 hover:text-accent hover:bg-surface-2 dark:text-slate-200"
              }`}
            >
              {t(tab.labelKey)}
            </Link>
